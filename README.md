...
- 当前版本为**内部测试版（0.1.40）**，尚未满足公开发布硬门禁；公开发布就绪评估见 `docs/release-readiness.md`。
...
- 公开未实现的功能缺口（仍未覆盖）：
  ...
  - 高级搜索、保存搜索、引用格式输出已有第一批命令实现，runtime 验收待安装 0.1.40 后执行
