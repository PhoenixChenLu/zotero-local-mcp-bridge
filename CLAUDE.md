...
This project is indexed by GitNexus as **Zotero-codex-bridge** (2525 symbols, 4503 relationships, 219 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
